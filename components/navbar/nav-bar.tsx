...
export default function Navbar({open, setOpen}:Type) {
  ...
  return (
    <>
      ...
      {!open ? (
         <nav className={`navbar w-full px-5 sm:px-4 lg:px-[90px] py-[28px] overflow-hidden ${open ? "opacity-60" :""}`}>
         <div className=" w-full flex gap-0 lg:gap-1 xl:gap-[92px] items-center rounded-lg  justify-between">
           <div className="flex  w-full  gap-4 justify-between  md:justify-start md:gap-6">
             <HiMenu
